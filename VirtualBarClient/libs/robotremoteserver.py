...
from remotecallfunction import VersionInfo,getFileVersion
...
class MyObject:
    ...
    def getVersionInfo(self):
        info = VersionInfo()
        return info.read_versioninfo()

    def getBsVersion(self):
        bsfile = r'c:\satp_wxol\jifeiserver\barserver\wxServer.exe'
        version = getFileVersion(bsfile)
        return version
    
    def haveKeywords(self):
        return dir(self)
...
class RobotRemoteServer(SimpleXMLRPCServer):
    ...
    def _register_functions(self):
        #remote call _obj function
        self.register_instance(self._obj)
    ...
    def get_keyword_names(self):
        ...
        return names + ['stop_remote_server', 'get_keyword_names']
